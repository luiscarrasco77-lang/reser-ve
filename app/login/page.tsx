    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box;}
        ...
        .auth-card{background:white;border:1.5px solid var(--line);border-radius:24px;padding:2.4rem 2.2rem;width:100%;max-width:420px;box-shadow:0 16px 56px rgba(26,43,76,0.10);}
