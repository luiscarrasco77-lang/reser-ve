  ...
  return (
    <>
      <style>{`
        ...
        * {
        ...
        .hero-bg {
          ...
          inset: 0;
          background:
            linear-gradient(180deg, rgba(253,251,247,0.10) 0%, rgba(253,251,247,0.62) 100%);
        }

        .hero-bg-img {
          position: absolute;
          inset: 0;
          background: url('https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=1800&q=80') center/cover no-repeat;
        ...
        .hero-overlay {
          ...
          inset: 0;
          background:
            linear-gradient(90deg, rgba(26,43,76,0.76) 0%, rgba(26,43,76,0.48) 35%, rgba(26,43,76,0.12) 65%, rgba(253,251,247,0.14) 100%);
        }
        ...
        .search-bar {
          ...
          backdrop-filter: blur(18px);
          -webkit-backdrop-filter: blur(18px);
          box-shadow: 0 20px 60px rgba(26,43,76,0.16);
          border-radius: 24px;
        }
        ...
        .dest-overlay {
          position: absolute;
          inset: 0;
          background: linear-gradient(to top, rgba(26,43,76,0.88) 0%, rgba(26,43,76,0.12) 65%);
        }
        ...
        @media (max-width: 768px) {
          ...
          .hero-overlay {
            background: linear-gradient(180deg, rgba(26,43,76,0.68) 0%, rgba(26,43,76,0.58) 42%, rgba(26,43,76,0.34) 100%);
          }
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <div className="hero-panel">
            ...
            <p className={`hero-sub ${loaded ? 'anim-2' : ''}`}>
              ...
              Reserva con confianza y paga en USD o bolívares con métodos como Zelle,
              Pago Móvil, transferencia o Binance.
            </p>
            ...
            <div className={`hero-btns ${loaded ? 'anim-3' : ''}`}>
              ...
              <a href="#posaderos" className="btn-secondary">
                ¿Tienes una posada?
              </a>
            </div>
          </div>
        ...
        <div className="scroll-hint">Descubre</div>
      </section>
      ...
      <section id="como-funciona" className="section">
        ...
        <h2 className="section-h2">
          Simple para <em>todos</em>
        </h2>
        <p className="section-sub">
          Desde la búsqueda hasta el check-in. Una experiencia clara, confiable y elegante para viajeros y posaderos.
        </p>

        <div className="tabs">
          <button
            className={`tab-btn ${activeTab === 'viajero' ? 'active' : ''}`}
            onClick={() => setActiveTab('viajero')}
          >
            Soy viajero
          </button>
          <button
            className={`tab-btn ${activeTab === 'posadero' ? 'active' : ''}`}
            onClick={() => setActiveTab('posadero')}
          >
            Tengo una posada
          </button>
        </div>
        ...
        {activeTab === 'viajero' ? (
          <div className="steps-grid">
            {[
              ...
              ['Elige con confianza', 'Fotos profesionales, perfiles cuidados y toda la información que necesitas antes de reservar.'],
              ['Reserva y paga fácil', 'Paga en USD o bolívares con opciones como Zelle, Pago Móvil, transferencia o Binance.'],
          ...
          <div className="steps-grid">
            {[
              ['Registra tu posada', 'Alta sencilla, visual y profesional para mostrar tu espacio con el nivel que merece.'],
      ...
      <section id="destinos" className="section">
        ...
        <h2 className="section-h2">
          Los rincones más <em>extraordinarios</em>
        </h2>
        <p className="section-sub">
          Posadas verificadas en destinos memorables de Venezuela, con una experiencia más boutique, cálida y confiable.
        </p>
        ...
        <div className="posadero-section">
          <div className="posadero-left">
            ...
            <h2 className="section-h2" style={{ marginBottom: '1.2rem' }}>
              Tu posada merece <br />
              <em>visibilidad real</em>
            </h2>

            <p className="section-sub" style={{ marginBottom: '1.4rem' }}>
              Deja de depender solo de WhatsApp. RESER-VE te ayuda a mostrar tu posada con una imagen premium,
              recibir reservas con más confianza y cobrar en USD o bolívares con flexibilidad.
            </p>
          ...
          <div className="posadero-right">
            <div className="plan-card">
              ...
              <div className="plan-price">
                $150 <span>USD / equivalente en bolívares</span>
              </div>
              <div className="plan-desc">
                Todo lo que necesitas para empezar a recibir reservas desde cualquier parte del mundo con una presencia más cuidada.
              </div>

              <ul className="plan-items">
                <li>Sesión fotográfica profesional</li>
                <li>Perfil completo en la plataforma</li>
                <li>Optimización visual y descripción del alojamiento</li>
